	...
	private void getResources() {
		try {
			mainFont = Font.createFont(Font.TRUETYPE_FONT, 
					CompletePanel.class.getResourceAsStream("/fonts/Titillium-Light.ttf"));
		...
		try {
			metalTileImg = ImageIO.read(CompletePanel.class.getResourceAsStream("/images/tile0.jpg"));
			playerTileImg = ImageIO.read(CompletePanel.class.getResourceAsStream("/images/tile1.jpg"));
			blueTileImg = ImageIO.read(CompletePanel.class.getResourceAsStream("/images/tile2.jpg"));
			redTileImg = ImageIO.read(CompletePanel.class.getResourceAsStream("/images/tile3.jpg"));
		} catch (IOException e) {
